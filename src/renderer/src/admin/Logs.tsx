...
export const Logs = () => {
  ...
  // Version is included in the query args to bust the RTK Query cache on every intentional reset,
  // ensuring a fresh network request even when offset and severity haven't changed.
  ...
  const reset = (newSeverity?: string) => {
      ...
      <Box>
        ...
        >
          <FormControl size="small" sx={{ minWidth: 150 }}>
            ...
            <Select value={severity} label={LL.ADMIN_LOGS.SEVERITY_LABEL()} onChange={(e) => handleSeverityChange(e.target.value)}>
